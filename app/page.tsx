...
<footer id="contact"><div className="eyebrow">КОНТАКТЫ</div><h2>Обсудим ваш<br/>следующий проект?</h2><div className="contact-links"><a href="mailto:rus-leb01@mail.ru">rus-leb01@mail.ru <span>↗</span></a><a href="https://www.behance.net/RuslanDesign21" target="_blank" rel="noopener noreferrer">Behance <span>↗</span></a></div><div className="footer-bottom"><span>© 2026 RNDR</span><span>Интерьерная визуализация</span><a href="#top">Наверх ↑</a></div></footer>
